<?php
/**
 * Template Name: Book now lonavla
 */
?>
	...
	<div class="row">
		<div class=" col-md-6">
            ...
            <a class="list-quotes" href="/">
                ...
                <img class='img-responsive img-size' alt="img" src="http://farmfun.in/wp-content/themes/hotel-melbourne/images/resort_small_lonavla05.jpg">
            </a>
...
<div class="quotes" style="margin-top: 50px">
                    <h1 style=" border-bottom: 3px solid #a7d500;
  display: inline;">LONAVALA</h1><br><br>
  <p style="padding-left:20px;">Lonavala is a hill station surrounded by green valleys in western India near Mumbai. The Karla Caves and the Bhaja Caves are ancient Buddhist shrines carved out of the rock.</p>
                     ...
                     <div class="col-xs-11" style="text-align: justify;line-height:24px;">
						...
						<h4 class="price" style="color:#000;margin-left: -20px;">RATE : <span>$800 /per person/ per night</span></h4>
					...
					<div class="row" style="padding-left:30px;">
							...
							<a class="col-xs-10 col-md-10 col-lg-10 col-sm-10 button" href="#">Book Now</a>
...
<div class="quotes" style="margin-top: 50px">
  ...
  display: inline;padding-left: 0px;display: inline;">ROOM FACILITIES</h1></div>
                     ...
                     <div class="col-xs-4">
                     	...
                     	<div class="col-xs-6" style="padding-left: 120px;">
							...
							<a class="col-xs-12 col-md-12 col-lg-12 col-sm-12 button" href="#">Details</a><br><br><br>
							</div>
		...
		<div class="col-md-6">
            ...
            <a class="list-quotes" href="/">
                ...
                <img class='img-responsive img-size' alt="img" src="http://farmfun.in/wp-content/themes/hotel-melbourne/images/resort_small_lonavla06.jpg"><br><br>
            </a>
