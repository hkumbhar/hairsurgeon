...
//Custom post type facilities
add_action( 'init', 'create_post_type_facilities' );
function create_post_type_facilities() {
  register_post_type( 'facilities',
    array(
      'labels' => array(
        'name' => __( 'Facilities' ),
        'singular_name' => __( 'Facilities' )
      ),
      'public' => true,
      'has_archive' => true,
    )
...
//add features image option in Portfolio custom post type
add_theme_support('post-thumbnails');
//add features image option for acme_porfolio CPT
add_post_type_support( 'acme_porfolio', 'thumbnail' );   
